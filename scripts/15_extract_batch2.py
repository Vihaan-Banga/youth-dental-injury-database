...
write_csv("mooney2021", [make("mooney2021",
    ...
    sex="mixed", level_of_play="club",
    sport_raw="Gaelic football (contact)",
    sport="all_sports_aggregate", sport_category="contact",
    subgroup_label="gaelic_football",
...
write_csv("zaror2018", [
    ...
    make("zaror2018", **za_common, sport_raw="handball", sport="all_sports_aggregate", sport_category="contact",
        subgroup_label="handball_team", sample_size=55,
