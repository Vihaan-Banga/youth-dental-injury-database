...
w("wormald2022", [
    make("wormald2022", **wormald_common, sex="mixed",
        ...
        injury_category="orofacial_with_dental",
        rate_raw=2.06, rate_denominator_raw="per 1000 athlete-exposure (AE) hours",
        rate_per_1000_ae=2.06,
        extraction_notes="Single-institution registry 13 NCAA D-I sports 4 seasons. 193 maxillofacial injuries. Overall 2.06/1000 AE-hours. M 1.92 / F 2.43 per 1000 AE-h.",
    ),
    make("wormald2022", **wormald_common, sex="male",
        ...
        subgroup_label="",
        rate_raw=8.30, rate_denominator_raw="per 1000 athlete-exposure (AE) hours (men's BB)",
        rate_per_1000_ae=8.30,
        extraction_notes="Men's basketball — highest rate at 8.30/1000 AE-h.",
    ),
    make("wormald2022", **wormald_common, sex="male",
        sport_raw="men's water polo (NCAA D-I)",
        sport="water_polo", sport_category="contact",
        subgroup_label="",
        rate_raw=8.15, rate_denominator_raw="per 1000 athlete-exposure (AE) hours (men's water polo)",
        rate_per_1000_ae=8.15,
        extraction_notes="Men's water polo — 8.15/1000 AE-h.",
    ),
])
...
w("emshoff1997", [
    ...
    make("emshoff1997", **emshoff_common,
        ...
        sport="all_sports_aggregate", sport_category="non_contact",  # skiing not in vocab
        subgroup_label="skiing",
        sample_size="",
